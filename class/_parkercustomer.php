       ...
       echo '<html>
             ...
             while ($row = $stmt->fetchObject()) {
              ...
              echo '<li class="cards__item">
                      <div class="card">
                      <div class="card__image"><img src="img/customers/'.$mycode.'.png" width="210px" height="100px" "alt="Not Available" ></div>
              ...
              echo '<br/><a href="salesdirect.php?c_code='.$mycode.'&status=A/R">Sales A/R</a>';
                                                ...
                                                //echo '<br/><a href="editphotocust.php?c_code='.$mycode.'">Edit Photo</a>';
                            echo '</div>';
