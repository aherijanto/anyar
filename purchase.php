...
$grandtotal=0;
    foreach ($_SESSION["cart_item"] as $item){
		?>
				...
				<td align="center" class="auto-style3"><a href="/purchase.php?action=remove&codetr= <?php echo $item["code"]; ?>" class="auto-style2" style="color:white;background-color:  #8e44ad; border-radius: 5px;text-decoration: none;padding: 10px">Remove Item</a></td>
