...
<table align="center" style="vertical-align:middle;">
    ...
    <tr>
        <td align="center"><input type="text" name="searchtext" placeholder="Type here.." style="width: 500px;"/></td>
    </tr>

    <tr>
        <td align="center"><font face="Arial" size="2">Search by:<input type="radio" name="searchradio" value="c_id" checked>Customer ID
                            <input type="radio" name="searchradio" value="c_name">Customer Name
                            <input type="radio" name="searchradio" value="c_addr">Customer Address</font>
        </td>
    </tr>
