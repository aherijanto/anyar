...
$_SESSION['reports']='0';
			...
			if(isset($_SESSION['cart_retsales'])){
				unset($_SESSION['cart_retsales']);
			}
...
if (isset($_POST['next'])){
	...
	header("Location:retsalesdetail.php?invtext=$myinv");
}
?>
<?php
...
<head>
 ...
 <div align="center" style="transform: translate(-50%, -50%);margin: 0;position: absolute;top: 30%;
  left: 50%;">
 	<label style="font-size: 24px;color:#1565C0;text-shadow: 2px 2px #AEB6BF">Type Invoice Sales No</label>
