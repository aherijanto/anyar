...
$conn3=mysqli_connect('localhost','mimj5729_myroot','myroot@@##','mimj5729_utama');
//mysqli_select_db('inventory');

echo '<table width="100%">';
echo '<tr><td colspan="2" class="headerbtm" align="center" >SBK</td></tr>';
echo '<tr><td colspan="2" class="headerbtm" align="center" >BREBES</td></tr>';
...
#---------------------------CheckIfReturn--------------------------------------------------------------------------------
	...
	$showdetailret= mysqli_query($conn3,$sqlret) or die(mysql_error());
	$negNumber=0;
	$totalNeg=0;
