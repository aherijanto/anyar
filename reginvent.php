<?php
  ...
  if (isset($_POST['saveinvent'])){
    ...
    $i_wareid=$_POST['slctwarehouse'];
		...
		$myinvent=new Inventory($i_code,$g_code,$i_supp,$i_barcode,$i_name,$i_qty,$i_qtymin,$i_unit,$i_ukuran,$i_warna,$i_merk,$i_artikel,$i_cogs,$i_kdsell,$i_sell,$i_sell2,$i_sell3,$i_sell4,$i_sell5,$i_sell6,$i_sell7,$i_sell8,$i_sell9,$i_sell10,$i_status,$i_wareid);
