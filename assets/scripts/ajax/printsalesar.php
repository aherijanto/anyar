...
echo '<head><title>INVOICE@' . $noinv . '</title></head>';
echo '<table  style="width:100%;">';
echo '<tr><td>' . $coname . '</td>
...
echo '<tr>
            ...
            <td align="right" style="font-size:16px;">' . $rowdue['c_addr'] . '</td>
         </tr>';
echo '<tr><td style="font-size:12px;font-weight:normal;padding-top:15px;font-style:italic;">Print Date: ' . date('d-m-Y') . '&nbsp&nbsp&nbsp&nbspPrint Time: ' . date('H:i:s') . '</td></tr>';
echo '</table>';
...
$showdetail = mysqli_query($conn, $sqlinv) or die(mysqli_error());
...
while ($row = mysqli_fetch_array($showdetail)) {
    ...
    echo '<tr>
                    ...
                    <td style="text-align:left;padding-left:40px;padding-top:3px;font-size:14px">' . $row['i_name'] . '</td>
...
echo '<div align="right" style="padding-top:10px;padding-right:10px;font-size:18px;font-weight:bold;">T O T A L :&nbsp&nbsp&nbsp&nbsp ' . number_format($grandtotal) . '</div>';
echo '<div style="font-size:12px;font-style:italic;"><a href="/searchengine1.php" style="text-decoration:none;color:black;">***Document dianggap sah apabila terdapat tandatangan dan stempel***</a></div>';
