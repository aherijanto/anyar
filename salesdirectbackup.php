       	...
       	if (isset($_POST['namesubmit']))
        {
           ...
           echo '<tr><td colspan="10" style="background-color:#873600  ;">RESULT::  '.$total.' record(s)</td></tr>';
             while ($row = $stmt->fetchObject()) {
               ...
               $mycode=$row->i_barcode;
               //$mygroup=$row->g_code;
			   //salesdirect.php?action=addname"
               $mysell=$row->i_sell;
               $myqty=$row->i_qty;
               $myarticle=$row->i_article;
               $itemname=$row->i_name;
               $iwarna=$row->i_color;
              	echo '<tr><form method="post" action="salesdirect.php?action=addname" id="formselectItem">';
                echo '<td width="100px" class="auto-style3" >'.$mycode.'</td><input type="hidden" name="code" value="'.$mycode.'" />';
                echo '<td width="150px" class="auto-style3" id="'.$itemname.'">'.$itemname.'</td><input type="hidden" name="itemname" value="'.$itemname.'" />';
                ...
                echo '<td width="50px" align="center" ><input type="text" name="disc3" style="text-align: center;width:20px;" /></td>';
               	echo '<td ><input type="submit"   name="addtolist" id="addtolist" style="text-align: center;background-color:#1F618D;padding:12px 5px;" value="Add to cart"/></td>';
				
				   echo '<td ><button name="btnPilihHrg" id="btnPilihHrg" class="btn btn-success" value="Pilih Harga"/></td>'; 
				//
               	echo '</tr></form>';
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                  	        <div class="form-group">
                                <label class="control-label">Harga #1 :</label>
                                <input type="text" id="txtharga1" class="form-control" maxlength="100">
								<button type="button" class="btn btn-primary" id="btnHarga1">Add</button>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label">Harga #2 :</label>
                                <input type="text" id="txtharga2" class="form-control" maxlength="100">
								<button type="button" class="btn btn-primary" id="btnHarga2">Add</button>
                            </div> 
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label">Harga #3 :</label>
                                <input type="text" id="txtharga3" class="form-control" maxlength="100">
								<button type="button" class="btn btn-primary" id="btnHarga3">Add</button>
                            </div> 
                        </div>
                    </div>
                </div>                
